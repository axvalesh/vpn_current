...
// vertex of the SlidingSegmentedControl's Rect.
//
...
const double _kCornerRadius = 100;
...
class _Segment<T> extends StatefulWidget {
  ...
  // Whether the thumb of the parent widget (SlidingSegmentedControl)
...
///
/// {@tool dartpad}
/// This example shows a [SlidingSegmentedControl] with an enum type.
///
...
class SlidingSegmentedControl<T> extends StatefulWidget {
  ...
  ///   @override
  ///   Widget build(BuildContext context) {
  ///     return SlidingSegmentedControl<int>(
  ///       children: children,
  ...
  @override
  State<SlidingSegmentedControl<T>> createState() => _SegmentedControlState<T>();
}
